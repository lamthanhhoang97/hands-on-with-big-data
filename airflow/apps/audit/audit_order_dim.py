...
def main():
    ...
    # read data
    hdfs_path = f"hdfs://hadoop:9000/user/hadoopuser/stage/stg_order_dim"
    ...
    data_quality_config = {
        "stg_order_dim": {
            "checks": [                               
                {"column": "o_orderkey", "type": "is_complete"},
                {'column': 'sk_orderkey', "type": 'is_complete'},
                {'column': 'record_active_flag', "type": 'is_complete'},
                {'column': 'sk_orderkey', "type": 'is_unique'},
            ]
        },
    }

    table_name = "stg_order_dim"
